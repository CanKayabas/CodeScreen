document.addEventListener("DOMContentLoaded", () => {
    ...
    const videoSources = [
        "https://www.shutterstock.com/shutterstock/videos/1067834006/preview/stock-footage-hacking-loading-bar-animation-with-green-code-animation.webm",
        "https://www.shutterstock.com/shutterstock/videos/3761937579/preview/stock-footage-python-source-code-software-hack-concept-program-source-code-programing-workflow-abstract.webm",
        "https://www.shutterstock.com/shutterstock/videos/1106505589/preview/stock-footage--k-programmer-coding-on-black-computer-screen-engineer-developing-software-app-typing-code-screen.webm",
        "https://www.shutterstock.com/shutterstock/videos/1089985763/preview/stock-footage-javascript-computer-programming-code-scroll-close-up-program-development-and-security-hacking-code.webm",
        "https://www.shutterstock.com/shutterstock/videos/1101147657/preview/stock-footage-white-hacker-code-appears-on-a-black-screen.webm",
        "https://www.shutterstock.com/shutterstock/videos/1023475264/preview/stock-footage-encrypted-fast-scrolling-programming-security-hacking-code.webm"
    ];
        ...
        selectedEffects.forEach((effect) => {
            ...
            `;
                ...
                case "distort":
                    ...
                    // Add pulsing effect
                    setTimeout(() => {
                        video.style.transform = `skew(${-skewX / 2}deg, ${-skewY / 2
                ...
                case "vhs":
                    ...
                    for (let i = 0; i < 3; i++) {
                        ...
                        setTimeout(() => {
                            trackingLine.style.transform = `translateY(${Math.random() * 50 - 25
                                }px)`;
                            setTimeout(() => {
                                trackingLine.remove();
                            }, 300);
                ...
                case "matrix":
                    ...
                    for (let i = 0; i < 20; i++) {
                        ...
                        matrixHtml += `<div style="opacity:${Math.random() * 0.7 + 0.3
                            }">${randomChars}</div>`;
                    }
    ...
    triggerGlitchBtn.addEventListener("click", () => {
        ...
        cameraFeeds.forEach((feed) => {
            ...
            video.style.transform = `translate(${Math.random() * 10 - 5}px, ${Math.random() * 10 - 5
                }px)`;

            // Color channel split
            video.style.boxShadow = `${Math.random() * 8 - 4
                }px 0 0 rgba(255,0,0,0.5), ${Math.random() * -8 + 4
